...
echo "  uv run python test_phase2_simple.py          # Test Phase 2 components"
echo "  uv run python test_document_ingestion.py     # Test full PDF processing"
echo "  uv run python test_phase3_embeddings.py      # Test Phase 3 embeddings"
