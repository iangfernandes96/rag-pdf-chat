...
class VectorStore:
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(f"Qdrant connection failed: {str(e)}") from e
    ...
    async def create_collection(self, overwrite: bool = False) -> bool:
        ...
        try:
            ...
            raise RuntimeError(f"Collection creation failed: {str(e)}") from e
    ...
    async def store_embeddings(
        ...
        try:
            ...
            raise RuntimeError(f"Embedding storage failed: {str(e)}") from e
